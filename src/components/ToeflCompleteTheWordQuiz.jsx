...
import { useCompleteWordInputs } from '../hooks/useCompleteWordInputs';
...
import { buildCompleteWordVocabularyPayload } from '../services/toefl/completeWordVocabulary';
import {
...
export default function ToeflCompleteTheWordQuiz({
  ...
  const handleSaveWordToVocabulary = async (word) => {
    ...
    try {
      ...
      await createWord(buildCompleteWordVocabularyPayload(wordData, word));
